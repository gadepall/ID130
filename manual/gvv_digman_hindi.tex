...
\begin{abstract}
यह आलेख  पाठकों को एक सरल विधि से अंकीय तर्क विधि से अवगत करने का प्रयास है।
%ॐ श्री गणेशाय नमः॥
%\\
%\indent जय श्री राम।
...
\section{वर्धमान गूढ़वाचक}
\input{hindi/incdec.tex}
%\section{Display Decoder}
%\input{chapters/dispdec.tex}
%
%\section{Karnaugh Map}
%\subsection{Incrementing Decoder}
%\input{chapters/kmap_inc.tex}
%\subsection{Display Decoder}
%\input{chapters/kmap_disp.tex}
%
%\section{Don't Care}
%\subsection{Incrementing Decoder}
%\input{chapters/kmapX_inc.tex}
%\subsection{Display Decoder}
%\input{chapters/kmapX_disp.tex}
%
%\section{Programming}
%%\input{chapters/prog.tex}
%
%\section{Logic Gates}
%\input{chapters/gates.tex}
%
%
